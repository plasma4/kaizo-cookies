		...
		Game.LoadSave=function(data,ignoreVersionIssues)
		{
			...
			if (str!='')
			{
				...
				else
				{
					...
					Game.loadedFromVersion=version;
					var betaProblem=(version==2.053&&Game.version==2.052);
					...
					{
						if (ignoreVersionIssues||betaProblem) Game.Notify(betaProblem?'Beta import':'Retrieving save from a future version.',betaProblem?'You are importing from the active beta (2.053). There could be some problems.':'That\'s...odd.','',0,1);
						else
						{
